...
try:
    ...
    today_names = [f"Google_{today}", f"Facebook_{today}", f"4attempt_{today}"]
    yesterday_names = [f"Google_{yesterday}", f"Facebook_{yesterday}", f"4attempt_{yesterday}"]
    day_2_names = [f"Google_{day_before_yesterday}", f"Facebook_{day_before_yesterday}", f"4attempt_{day_before_yesterday}"]
    five_days_old_names = [f"Google_{five_days_ago}", f"Facebook_{five_days_ago}", f"4attempt_{five_days_ago}"]
